...
export function KeyframeEditor() {
  ...
  return (
    <Card className="bg-background/50 flex h-[300px] w-full flex-col gap-4 p-4">
      ...
      <div className="bg-muted/20 relative min-h-0 w-full flex-1 rounded-lg p-2">
        ...
        <div className="border-primary bg-background absolute bottom-2 left-2 h-3 w-3 cursor-move rounded-full border-2" />
        <div className="border-primary bg-background absolute top-2 right-2 h-3 w-3 cursor-move rounded-full border-2" />
      </div>
    </Card>
  );
}
