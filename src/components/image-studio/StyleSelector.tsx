...
const STYLES = [
  {
    ...
    description:
      'Mimics the properties of a photograph, focusing on accurate lighting, texture, and depth of field.',
  },
  {
    id: 'anime',
    name: 'Anime',
    ...
    description:
      'Vibrant colors, exaggerated expressions, and distinct line art typical of Japanese animation.',
  },
  {
    id: 'digital-art',
    name: 'Digital Art',
  ...
  },
  {
    ...
    description:
      'Visible brushstrokes, rich textures, and blending of colors resembling traditional oil on canvas.',
  },
  {
    id: 'neon-cyberpunk',
    name: 'Neon / Cyberpunk',
  ...
  },
  {
    ...
    description:
      'Smooth surfaces, ambient occlusion, and ray-traced lighting typical of Blender or Cinema4D renders.',
  },
  {
    id: 'isometric',
    name: 'Isometric',
    ...
    description:
      '3D-like representation in 2D space where the three axes appear equally foreshortened.',
  },
  {
    id: 'pixel-art',
    name: 'Pixel Art',
    ...
    description:
      'Retro aesthetic where individual pixels are visible, reminiscent of 8-bit or 16-bit games.',
  },
];
        ...
        >
          <span className="flex items-center gap-2">
            ...
            <span className="font-medium">
              {activeStyle ? activeStyle.name : 'Choose a Style...'}
            </span>
          </span>
                ...
                <Tooltip delayDuration={300}>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={cn(
                        'relative aspect-square w-full overflow-hidden rounded-xl border-2 text-left transition-all',
                        value === style.id
                          ? 'border-primary ring-primary/20 scale-[1.02] ring-2'
                          : 'hover:border-primary/50 border-transparent hover:scale-[1.01]',
                      )}
                    >
                      <img
                        src={style.image}
                  ...
                  <TooltipContent
                    side="top"
                    className="bg-popover/95 border-primary/20 max-w-[220px] text-center backdrop-blur"
                  >
                    <p className="text-primary mb-1 text-xs font-medium">{style.name}</p>
