        ...
        <div className="space-y-6">
            <div className="space-y-4">
                <div className="flex justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">{camera.zoom.toFixed(1)}</span>
                </div>
                <Slider
                    value={[camera.zoom]}
                    min={-1}
            ...
            <div className="space-y-4">
                <div className="flex justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">{camera.pan.x.toFixed(1)}</span>
                </div>
                <Slider
                    value={[camera.pan.x]}
                    min={-1}
            ...
            <div className="space-y-4">
                <div className="flex justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">{camera.pan.y.toFixed(1)}</span>
                </div>
                <Slider
                    value={[camera.pan.y]}
                    min={-1}
