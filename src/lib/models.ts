    ...
    models: [
      {
        ...
        specs: { contextWindow: 128000, modalities: ['text'] },
      },
    ...
    models: [
      {
        ...
        providerId: 'vllm',
        isLocal: true,
        description: 'Your vLLM endpoint',
      },
    ],
  },
  ...
  // ===== CLOUD PROVIDERS =====
  {
    ...
    models: [
      ...
      },
      {
        ...
        pricing: { inputPerMillion: 12.0, outputPerMillion: 36.0 },
        specs: {
          contextWindow: 256000,
      ...
      },
      {
        ...
        pricing: { inputPerMillion: 1.5, outputPerMillion: 6.0 },
      ...
      // GPT-4o Legacy
      {
        ...
        pricing: { inputPerMillion: 2.5, outputPerMillion: 10.0, cachedInputPerMillion: 1.25 },
        specs: {
